...
class AppFixtures extends AbstractFixture
{
    ...
    public function __construct(private UserPasswordHasherInterface $passwordHasher, SluggerInterface $slugger = null)
    {
    ...
    private function getUserData(): array
    {
        return [
            ...
            ['Jane Doe', 'jane_admin', 'kitten', 'jane_admin@biurad.com', ['ROLE_ADMIN']],
            ['Tom Doe', 'tom_admin', 'kitten', 'tom_admin@biurad.com', ['ROLE_ADMIN']],
            ['John Doe', 'john_user', 'kitten', 'john_user@biurad.com', ['ROLE_USER']],
        ];
    }
